...
//marker component
#[derive(Component)]
struct Player;//this is a marker component.a struct with zero fields.it's like a sticky note.it's to be attached on a component to identify that as Player.
